...
DETECTION_ROOT   = "trainings/jersey-number-detection-1"
DETECTION_CLEAN  = "trainings/jersey-number-detection-cleaned"

# Loại B: Classification format (thư mục = nhãn)
CLASSIFY_ROOT    = "trainings/jersey-number-classification-1"
CLASSIFY_CLEAN   = "trainings/jersey-number-classification-cleaned"
...
def visualize_jersey_stats(class_counter, blur_scores,
    ...
    if class_counter:
        ...
        ax.set_xlabel(
            f"{under} so ao co duoi 5 mau (can tang cuong)",
